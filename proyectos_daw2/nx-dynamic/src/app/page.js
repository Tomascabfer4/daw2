  ...
  return (
    <section className="min-h-screen max-w-[1024px] mx-auto px-10">
      ...
      <div className="h-[600px] flex flex-col gap-10 justify-center content-center">
        <div className="flex flex-col gap-10 border-4 rounded-lg border-red-500 gap-10">
          <h1 className="py-2 text-2xl text-red-500 text-center border-b-4 border-b-red-500">
            PRODUCTOS
          </h1>
          ...
          <div className="flex flex-col items-center">
            ...
            <p>
              ...
              <span className="font-bold">
                Deberás tener una servidor MySQL para la DB local.
              </span>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p>
              Requisitos previos:{" "}
              <span className="font-bold">
                Deberás tener un servidor JSON para la API local.
              </span>
            </p>
          </div>
        </div>
